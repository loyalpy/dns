...
require_once(ROOT_PATH.'lib/plugins/nusoaplib/nusoap.php');
 ...
 *private static $gwUrl = 'http://sdk4report.eucp.b2m.cn:8080/sdk/SDKService';
	private static $serialNumber = '0SDK-EAA-6688-JEURT';
	private static $password = '724159';
	private static $sessionKey = '789653';
	private static $connectTimeOut = 2;
	private static $readTimeOut = 10;
	
	private static $proxyhost = false;
	private static $proxyport = false;
	private static $proxyusername = false;
	private static $proxypassword = false;
 * 
 * 
 * 
 * 
...
class YmClient{
	 ...
	 * 网关地址
	 */
	var $url = 'http://sdk4report.eucp.b2m.cn:8080/sdk/SDKService';
	
	/**
	 * 序列号,请通过亿美销售人员获取
	 */
	var $serialNumber = '0SDK-EAA-6688-JEURT';
	 ...
	 * 
	 */
	function YmClient($url,$serialNumber,$password,$sessionKey='',$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 3, $response_timeout = 10)
	{
		$this->url = $url;
