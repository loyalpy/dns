		...
		<div class="sidebar">
			...
			<div class="pnlink">
				...
				<div class="prevnext">
					...
					<p class="f14"><span class="txt-gray">下一篇：</span><a class="font-blue" href="<?php echo U('/cms/news_topic/tid/'.$prevnext['prev']['tid']);?>" title="<?php echo isset($prevnext['prev']['subject'])?$prevnext['prev']['subject']:"";?>"><?php echo isset($prevnext['prev']['subject'])?$prevnext['prev']['subject']:"";?></a></p>
					<?php }?>
					<?php if($prevnext['next']){?>
					<p class="f14"><span class="txt-gray">上一篇：</span><a class="font-blue" href="<?php echo U('/cms/news_topic/tid/'.$prevnext['next']['tid']);?>" title="<?php echo isset($prevnext['next']['subject'])?$prevnext['next']['subject']:"";?>"><?php echo isset($prevnext['next']['subject'])?$prevnext['next']['subject']:"";?></a></p>
					<?php }?>
				</div>
				<?php }?>
			</div>
