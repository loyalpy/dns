...
<div class="header">
  <div class="aps">
	...
	<li><a href="<?php echo U("/user_manager/module_config?ut=$key");?>" class="<?php if($ut == $key){?>cur<?php }?>"><?php echo isset($item['name'])?$item['name']:"";?></a></li>
    <?php }?>
    </ul>
    </div>
      <div class="cl"></div>
...
<div class="main-nav">
  ...
  <div class="navbtn">
  <!--button-->
  <button type="button" data-url="<?php echo U("/user_manager/module_config?do=refresh&ut=$ut");?>" class="btn btn-default btn-sm t-ajax-button" data-loading-text="处理中……">&nbsp;<cite class="glyphicon glyphicon-refresh"></cite>&nbsp;</button>
  <!--end button-->
  <!--button-->
  <a href="javascript:void(0)" data-url="<?php echo U("/user_manager/module_config?do=edit&ut=$ut");?>" class="btn btn-primary btn-sm addbtn">
...
<#macro row data>
    ...
    <td><#if (data.status == 1)><font class="font-green">显示</font><#else><font class="font-gray">隐藏</font></#if>
    <font class="font-gray">[<#if (data.isopen == 1)><font class="font-org">开</font><#else>关</#if>]</font>
    </td>
    <td>
	<p class="table-item-op">
	<a href="javascript:void(0);" class="editbtn" data-url="<?php echo U("/user_manager/module_config?do=edit&ut=$ut&id=");?>${data.id}"><span class="glyphicon glyphicon-edit"></span></a> 
	<a href="javascript:void(0);" class="copybtn" data-url="<?php echo U("/user_manager/module_config?do=copy&ut=$ut&id=");?>${data.id}"><span class="glyphicon glyphicon-repeat"></span></a> 
	<a href="javascript:void(0);" class="delbtn" data-url="<?php echo U("/user_manager/module_config?do=del&ut=$ut&id=");?>${data.id}"><span class="glyphicon glyphicon-remove"></span></a> 
	</p>
	</td>
	</tr>
</#macro>
...
<form action="<?php echo U("/user_manager/module_config?do=edit&ut=$ut");?>" method="post" class="theform form form-2" role="form">
<div class="tpl"></div>
</form>
</div>
</#macro>
...
var formdata = {
	...
	status:{type:"checkbox",label:"是否显示",name:"status",value:"1",data_sr:[{key:"1",v:"显示"}],css:"",require:"",desc:"",item_css:"font-red col-md-6"},
...
var load_list = function(){
	...
	},"<?php echo U("/user_manager/module_config?do=get&ut=$ut");?>");
}
