...
<div class="main-nav">
  ...
  <div class="navbtn">
  <!--button-->
	  <?php if($this->check_purview('/user_manager/loginlog_refresh')){?>
...
<!--search box-->
<form enctype="multipart/form-data" class="the_searchform form" method="POST" action="<?php echo U("/user_manager/loginlog?do=get_url");?>">
<div class="tpl"></div>
</form>
<!--end search box -->
<!-- list box -->
