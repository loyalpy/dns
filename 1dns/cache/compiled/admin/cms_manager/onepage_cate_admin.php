...
<#macro row data>
	...
	<a href="javascript:void(0);" class="editbtn" data-url="<?php echo U("/cms_manager/onepage_cate?do=edit&id=");?>${data.code}"><span class="glyphicon glyphicon-edit"></span></a> 
	<a href="javascript:void(0);" class="delbtn" data-url="<?php echo U("/cms_manager/onepage_cate?do=del&id=");?>${data.code}"><span class="glyphicon glyphicon-remove"></span></a> 
	</p>
	</td>
	</tr>
</#macro>
...
<form action="<?php echo U("/cms_manager/onepage_cate?do=edit");?>" method="post" class="theform form form-1" role="form">
<div class="tpl"></div>
</form>
</div>
</#macro>
...
var load_list = function(){
	...
	},"<?php echo U("/cms_manager/onepage_cate?do=get");?>");
}
