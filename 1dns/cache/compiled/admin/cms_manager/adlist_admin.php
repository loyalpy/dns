...
<div class="main-nav">
  ...
  <a href="<?php echo U("/cms_manager/adlist_edit?cat_id=$condi[cat_id]");?>" class="btn btn-primary btn-sm">
...
<#macro row data>
    ...
    <img src="<?php echo U("static@/");?>${data.imgurl}" width="100" />
    <#else>
    -
    </#if>
    </td>
...
<font class="font-gray">${data.content}</font></td>
	...
	<p class="table-item-op">
		<?php if($this->check_purview("/cms_manager/adlist_edit")){?>
	<a href="<?php echo U("/cms_manager/adlist_edit?id=");?>${data.id}"  ><span class="glyphicon glyphicon-edit"></span></a>
		<?php }?>
		<?php if($this->check_purview("/cms_manager/adlist_del")){?>
	<a href="javascript:void(0);" class="delbtn" data-url="<?php echo U("/cms_manager/adlist_del?id=");?>${data.id}"><span class="glyphicon glyphicon-remove"></span></a>
		<?php }?>
	</p>
	</td>
	</tr>
...
<form action="<?php echo U("/cms_manager/adlist_edit");?>" method="post" class="theform form form-1" role="form">
<div class="tpl"></div>
...
<?php }?>
var search_formdata = {
	cat_id:{type:"select",label:"分类",name:"cat_id",value:"<?php echo isset($condi['cat_id'])?$condi['cat_id']:"";?>",disabled:0,data_sr:cat_list_v,css:"low",require:"",desc:"",item_css:"item-400"},
