...
<div class="menu">
    <ul>
        ...
        <li><a href="<?php echo U("/domain_manager/domain_black");?>" class="cur">黑白名单</a></li>
        <?php }?>
...
<!--search box-->
<form class="the_searchform form" method="POST" action="<?php echo U("/domain_manager/domain_black?do=get_url");?>">
    <div class="tpl"></div>
</form>
<!--end search box -->
<!-- list box -->
...
<script type="text/template" id="tpl_list_row">
    <#macro row data>
        <tr>
            ...
            <td>
                <?php if($this->check_purview("/domain_manager/domain_blackdel")){?>
                <p class="table-item-op">
                    <a href="javascript:void(0);" class="delbtn" data-url="<?php echo U("/domain_manager/domain_blackdel?id=");?>${data.id}"><span class="glyphicon glyphicon-remove"></span></a>
                </p>
                <?php }else{?> -
                <?php }?>
            </td>
...
<script type="text/template" id="tpl_list_add">
    <#macro rowedit data>
        ...
        <div class="form-content">
            <form action="<?php echo U("/domain_manager/domain_blackadd");?>" method="post" class="theform form form-2" role="form">
                <div class="tpl"></div>
            </form>
        </div>
    </#macro>
