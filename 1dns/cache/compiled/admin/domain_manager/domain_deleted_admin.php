...
<div class="menu">
    <ul>
        ...
        <li><a href="<?php echo U("/domain_manager/domain_deleted");?>" class="cur">已删除域名</a></li>
        <?php }?>
...
<!--search box-->
<form class="the_searchform form" method="POST" action="<?php echo U("/domain_manager/domain_deleted?do=get_url");?>">
    <div class="tpl"></div>
</form>
<!--end search box -->
<!-- list box -->
