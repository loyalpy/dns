...
<div class="menu">
    <ul>
        ...
        <li><a href="<?php echo U("/domain_manager/domain_bind");?>" class="cur">别名绑定</a></li>
        <?php }?>
    </ul>
</div>
      <div class="cl"></div>
...
<!--search box-->
<form class="the_searchform form" method="POST" action="<?php echo U("/domain_manager/domain_bind?do=get_url");?>">
    <div class="tpl"></div>
</form>
<!--end search box -->
<!-- list box -->
        ...
        $.ajaxLoadlist(page,pageurl,function(){
            ...
            $(".del-bind-domain").click(function () {
                ...
                if (confirm("你确定要删除吗?删除后不可恢复！")) {
                    var url = "<?php echo U("/aapi/Domain.DelDomainBind");?>";
                    $.ajaxPassport({
                        url: url,
