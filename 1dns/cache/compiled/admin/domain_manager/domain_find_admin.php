...
<div class="menu">
    <ul>
        ...
        <li><a href="<?php echo U("/domain_manager/domain_find");?>" class="cur">域名找回</a></li>
        <?php }?>
...
<!--search box-->
<form class="the_searchform form" method="POST" action="<?php echo U("/domain_manager/domain_find?do=get_url");?>">
    <div class="tpl"></div>
</form>
<!--end search box -->
<!-- list box -->
