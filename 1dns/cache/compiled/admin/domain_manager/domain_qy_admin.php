...
<div class="menu">
    <ul>
        ...
        <li><a href="<?php echo U("/domain_manager/domain_qy");?>" class="cur">域名牵引</a></li>
        <?php }?>
...
<div class="main-nav">
    ...
    <div class="navbtn0">
        <a class="btn <?php if($c == 0){?>btn-info<?php }else{?>btn-default<?php }?> btn-sm" title="" href="<?php echo U("/domain_manager/domain_qy");?>"><cite class="glyphicon glyphicon-th"></cite> 待解封</a>
        <a class="btn <?php if($c == 1){?>btn-info<?php }else{?>btn-default<?php }?> btn-sm"  href="<?php echo U("/domain_manager/domain_qy?c=1");?>"><cite class="glyphicon glyphicon-th"></cite> 解封历史</a>
        <a class="btn <?php if($c == 2){?>btn-info<?php }else{?>btn-default<?php }?> btn-sm"  href="<?php echo U("/domain_manager/domain_qy?c=2");?>"><cite class="glyphicon glyphicon-th"></cite> 永久解封</a>
    </div>
    <div class="cl"></div>
</div>
<!--search box-->
<form class="the_searchform form" method="POST" action="<?php echo U("/domain_manager/domain_qy?do=get_url");?>">
    <div class="tpl"></div>
</form>
<!--end search box -->
<!-- list box -->
        ...
        <tr>
            ...
            <td>
                <#if ((data.status == 0) || (data.status == 2))>
                    <?php if($this->check_purview("/domain_manager/domain_qy_unlock")){?>
    ...
    var loadlist = function(page){
        $.ajaxLoadlist(page,pageurl,function(res){
            ...
            $(".domain-jf").click(function () {
                ...
                $.ui.loading();
                $.ajaxPassport({
                    url:"<?php echo U("/domain_manager/domain_qy_unlock");?>",
