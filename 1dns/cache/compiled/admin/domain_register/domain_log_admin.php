...
<div class="menu">
    <ul>
        ...
        <li><a href="<?php echo U("/domain_register/domain_log");?>" class="cur">域名操作日志</a></li>
    </ul>
</div>
      <div class="cl"></div>
    </div>
...
<!--search box-->
<form class="the_searchform form" method="POST" action="<?php echo U("/domain_register/domain_log?do=get_url");?>">
    <div class="tpl"></div>
</form>
<!--end search box -->
<!-- list box -->
