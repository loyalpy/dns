...
<div class="main-nav">
  ...
  <div class="navbtn0">
  <a class="btn <?php if($ftype == 1){?>btn-info<?php }else{?>btn-default<?php }?> btn-sm"  href="<?php echo U("/order_manager/register?ftype=1");?>"><cite class="glyphicon glyphicon-th"></cite>已支付</a>
  <a class="btn <?php if($ftype == 2){?>btn-info<?php }else{?>btn-default<?php }?> btn-sm"  href="<?php echo U("/order_manager/register?ftype=2");?>"><cite class="glyphicon glyphicon-th"></cite>待支付</a>
  <a class="btn <?php if($ftype == 3){?>btn-info<?php }else{?>btn-default<?php }?> btn-sm"  href="<?php echo U("/order_manager/register?ftype=3");?>"><cite class="glyphicon glyphicon-th"></cite>已取消</a>
  <a class="btn <?php if($ftype == 4){?>btn-info<?php }else{?>btn-default<?php }?> btn-sm"  href="<?php echo U("/order_manager/register?ftype=4");?>"><cite class="glyphicon glyphicon-th"></cite>已删除</a>
  </div>
  <div class="navbtn">
  </div>
  <div class="cl"></div>
...
<!--search box-->
<form class="the_searchform form" method="POST" action="<?php echo U("/order_manager/register?do=get_url");?>">
<div class="tpl"></div>
</form>
<!--end search box -->
<!-- list box -->
