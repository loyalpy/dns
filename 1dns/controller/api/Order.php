                            ...
                            if ($item['type'] == 1) {//新买
                                ...
                                if($domain_reg_id){
                                    ...
                                    if ($d_r['status'] != 1) {//注册失败
                                        ...
                                        $tlog->write("operation",array($item['domain'],arrayToString($d_r)));
                                        tCache::write("domain_register_res",$d_r);
                                    }else{//注册成功
                                        $item_ids[] = $item['item_id'];
                                ...
                                if ($renew_res['status'] != 1) {//续费失败
                                    ...
                                    //$tlog->write("operation",$renew_res);
                                    $tlog->write("operation",array($item['domain'],arrayToString($renew_res)));
                                    tCache::write("domain_renew_res",$renew_res);
                                }else {//续费成功
                                    $item_ids[] = $item['item_id'];
